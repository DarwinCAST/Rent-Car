...
namespace ConcecionarioAutomoviles.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(ConcecionarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdVendedor,NombreVendedor,Nif,DomicilioVendedor")] Vendedore vendedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVendedor,NombreVendedor,Nif,DomicilioVendedor")] Vendedore vendedore)
        {
